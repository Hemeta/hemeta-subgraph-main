...
export class HemetaHemeERC20V2 extends ethereum.SmartContract {
  static bind(address: Address): HemetaHemeERC20V2 {
    return new HemetaHemeERC20V2("HemetaHemeERC20V2", address);
  }
