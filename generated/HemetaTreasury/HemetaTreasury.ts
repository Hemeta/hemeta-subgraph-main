...
export class HemetaTreasury extends ethereum.SmartContract {
  static bind(address: Address): HemetaTreasury {
    return new HemetaTreasury("HemetaTreasury", address);
  }
  ...
  sHEMEQueue(): BigInt {
    let result = super.call("sHEMEQueue", "sHEMEQueue():(uint256)", []);

    return result[0].toBigInt();
  }

  try_sHEMEQueue(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("sHEMEQueue", "sHEMEQueue():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class RepayDebtWithHEMECall extends ethereum.Call {
  get inputs(): RepayDebtWithHEMECall__Inputs {
    return new RepayDebtWithHEMECall__Inputs(this);
  }

  get outputs(): RepayDebtWithHEMECall__Outputs {
    return new RepayDebtWithHEMECall__Outputs(this);
  }
}

export class RepayDebtWithHEMECall__Inputs {
  _call: RepayDebtWithHEMECall;

  constructor(call: RepayDebtWithHEMECall) {
    this._call = call;
  }
...
export class RepayDebtWithHEMECall__Outputs {
  _call: RepayDebtWithHEMECall;
