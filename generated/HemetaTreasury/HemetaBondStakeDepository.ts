...
export class HemetaBondStakeDepository__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HemetaBondStakeDepository__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HemetaBondStakeDepository__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HemetaBondStakeDepository extends ethereum.SmartContract {
  static bind(address: Address): HemetaBondStakeDepository {
    return new HemetaBondStakeDepository("HemetaBondStakeDepository", address);
  }
  ...
  adjustment(): HemetaBondStakeDepository__adjustmentResult {
    ...
    return new HemetaBondStakeDepository__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<
    HemetaBondStakeDepository__adjustmentResult
  > {
    ...
    return ethereum.CallResult.fromValue(
      new HemetaBondStakeDepository__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): HemetaBondStakeDepository__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new HemetaBondStakeDepository__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<HemetaBondStakeDepository__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HemetaBondStakeDepository__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  sHEME(): Address {
    let result = super.call("sHEME", "sHEME():(address)", []);

    return result[0].toAddress();
  }

  try_sHEME(): ethereum.CallResult<Address> {
    let result = super.tryCall("sHEME", "sHEME():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  terms(): HemetaBondStakeDepository__termsResult {
    let result = super.call(
      "terms",
    ...
    return new HemetaBondStakeDepository__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<HemetaBondStakeDepository__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HemetaBondStakeDepository__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
