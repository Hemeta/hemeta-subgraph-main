...
export class StakedHemetaHemeERC20V2__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class StakedHemetaHemeERC20V2 extends ethereum.SmartContract {
  static bind(address: Address): StakedHemetaHemeERC20V2 {
    return new StakedHemetaHemeERC20V2("StakedHemetaHemeERC20V2", address);
  }
  ...
  rebases(param0: BigInt): StakedHemetaHemeERC20V2__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new StakedHemetaHemeERC20V2__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<StakedHemetaHemeERC20V2__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new StakedHemetaHemeERC20V2__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
