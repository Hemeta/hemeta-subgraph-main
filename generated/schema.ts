...
export class ProtocolMetric extends Entity {
  constructor(id: string) {
    ...
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
    this.set("hemeCirculatingSupply", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("sHemeCirculatingSupply", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("totalSupply", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("hemePrice", Value.fromBigDecimal(BigDecimal.zero()));
    ...
    this.set("nextDistributedHeme", Value.fromBigDecimal(BigDecimal.zero()));
    this.set(
    ...
    this.set("treasuryHemeMaiPOL", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("treasuryHemeFraxPOL", Value.fromBigDecimal(BigDecimal.zero()));
  }
  ...
  get hemeCirculatingSupply(): BigDecimal {
    let value = this.get("hemeCirculatingSupply");
    return value!.toBigDecimal();
  }

  set hemeCirculatingSupply(value: BigDecimal) {
    this.set("hemeCirculatingSupply", Value.fromBigDecimal(value));
  }

  get sHemeCirculatingSupply(): BigDecimal {
    let value = this.get("sHemeCirculatingSupply");
    return value!.toBigDecimal();
  }

  set sHemeCirculatingSupply(value: BigDecimal) {
    this.set("sHemeCirculatingSupply", Value.fromBigDecimal(value));
  }
  ...
  get hemePrice(): BigDecimal {
    let value = this.get("hemePrice");
    return value!.toBigDecimal();
  }

  set hemePrice(value: BigDecimal) {
    this.set("hemePrice", Value.fromBigDecimal(value));
  }
  ...
  get nextDistributedHeme(): BigDecimal {
    let value = this.get("nextDistributedHeme");
    return value!.toBigDecimal();
  }

  set nextDistributedHeme(value: BigDecimal) {
    this.set("nextDistributedHeme", Value.fromBigDecimal(value));
  }
  ...
  get treasuryHemeMaiPOL(): BigDecimal {
    let value = this.get("treasuryHemeMaiPOL");
    return value!.toBigDecimal();
  }

  set treasuryHemeMaiPOL(value: BigDecimal) {
    this.set("treasuryHemeMaiPOL", Value.fromBigDecimal(value));
  }

  get treasuryHemeFraxPOL(): BigDecimal {
    let value = this.get("treasuryHemeFraxPOL");
    return value!.toBigDecimal();
  }

  set treasuryHemeFraxPOL(value: BigDecimal) {
    this.set("treasuryHemeFraxPOL", Value.fromBigDecimal(value));
  }
}
